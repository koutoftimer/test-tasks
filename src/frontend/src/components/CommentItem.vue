  ...
  <div class="comment-item" :style="{ marginLeft: depth * 24 + 'px' }">
    <div class="comment-card">
      ...
      <div v-if="comment.file" class="comment-file">
        <img v-if="comment.file_type === 'image'" :src="comment.file" alt="Attachment" class="comment-image" @click="openLightbox(comment.file)" />
...
.comment-actions { padding-top: 6px; border-top: 1px solid #f0f0f0; }
